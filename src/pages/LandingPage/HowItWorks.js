        ...
        <div className="grid grid-cols-3 justify-items-center gap-[60px]">
          {myArray.map((items) => (
            <div className="flex flex-col gap-[30px]">
              <div className="flex flex-col gap-[16px] max-w-[360px] items-center">
                <div className="h-[67px] w-[67px] rounded-[70px] flex justify-center items-center font-bold text-white bg-[#120B48]">
                  {items.num}
                </div>
                <div>
                  <p className="text-[28px] font-bold]">{items.title}</p>
                </div>
