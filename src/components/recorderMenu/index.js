        ...
        <div className="flex justify-center items-center gap-4">
          ...
          <div className="border-l flex gap-[24px]">
            {ToggleMenu.map((items) => (
              <div className="flex pl-4 gap-[24px]">
                <div className="flex flex-col relative">
                  <div className="h-[44px] w-[44px]  rounded-[40px] bg-white flex justify-center items-center">
                    <img src={items.img} />
                  </div>
                  {items.switch === true ?
            ...
            <div className="flex flex-col">
              <div className="h-[44px] w-[44px] rounded-[40px] bg-[#4B4B4B] flex justify-center items-center">
                <img src={trash} />
              </div>
            </div>
          </div>
